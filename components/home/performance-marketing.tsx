...
export function PerformanceMarketing({ isExpanded, onToggle }: PerformanceMarketingProps) {
  return (
    <>
      ...
      {/* Detailed Performance Marketing section */}
      {isExpanded && (
        <div className="relative bg-[#334e4d] h-[320px] w-full transition-all duration-300">
          ...
          {/* Right side image */}
          <div className="absolute h-[320px] right-[162px] top-0 w-[366px]" data-node-id="115:10809">
          ...
          {/* Left side content */}
          <div className="absolute flex flex-col gap-[24px] items-start left-[162px] top-[50px] w-[546px]" data-node-id="115:10810">
            <div className="flex flex-col gap-[16px] items-start w-full">
              <div className="font-['Public_Sans'] text-white text-[24px] font-normal leading-[normal] w-full" data-node-id="115:10812">
                Digital Media Buying
              </div>
              <div className="font-['Public_Sans'] text-white text-[14px] font-normal leading-[20px] w-full space-y-[12px]" data-node-id="115:10813">
                ...
                <p>Risus dui tristique elementum adipiscing nunc at eu morbi. Eu semper sagittis amet suspendisse morbi. In suspendisse tincidunt rutrum non vitae lorem amet nam. Ut sagittis enim tincidunt vestibulum tristique viverra.</p>
              </div>
            </div>

            {/* CTA Button */}
            <div className="bg-[#f1ff66] flex gap-[6px] items-center justify-center px-[18px] py-[10px] rounded-[6px] cursor-pointer hover:bg-[#e6ee5f] transition-all duration-300 transform hover:scale-105 active:scale-95" data-node-id="115:10814">
              <div className="font-['Public_Sans'] text-[#334e4d] text-[14px] font-semibold leading-[normal] whitespace-nowrap" data-node-id="115:10815">
  Let&apos;s Discuss
              </div>
              <div className="relative shrink-0 size-[20px] transition-transform duration-300 hover:translate-x-0.5 hover:-translate-y-0.5" data-name="arrow-up-right" data-node-id="115:10816">
